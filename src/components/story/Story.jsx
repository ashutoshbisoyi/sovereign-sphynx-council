        ...
        <div className='row'>
          ...
          <div className='col-12 col-lg-6 d-flex align-items-center'>
            <div className='content'>
              ...
              <p>
                Genesis Sphynxes (ETH) receive rewards from yield generated by
                the{' '}
                <a href='https://thesphynx.co' target='_blank' rel='noreferrer'>
                  https://thesphynx.co
                </a>{' '}
                Ether Bridge.
              </p>
              <p>
                Both Genesis and Scion Sphynxes (BSC) are granted VIP Whitelist
                Access to 5+ Project Launches on Sphynx Pad each month.
                Legendary and Pharoah Scion Sphynxes will receive VIP Whitelist
                access to 15+ Project Launches each month.
              </p>
              <p>All Members of the Council get the following perks:</p>
              <ul>
                <li>
